...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/abdulrahman305/qenex-lab/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for abdulrahman305/qenex-lab...\n")
...
console.log("Fetching npm all-time downloads for qenex-lab...\n")
const npmDownloads = await fetchNpmDownloads("qenex-lab")
