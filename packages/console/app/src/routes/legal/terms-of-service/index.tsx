...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>QENEX LAB | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="QENEX LAB terms of service" />
          ...
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                ...
                Models") and certain of these models are provided directly by us if you use the QENEX LAB Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, QENEX LAB enables you to
              ...
              <h2 id="what-are-the-basics">What are the basics of using QENEX LAB?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by QENEX LAB;
                </li>
                <li>
              ...
              <p>
                If you use QENEX LAB with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                QENEX LAB has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the QENEX LAB Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without QENEX LAB's prior written
              ...
              <p>
                Either you or QENEX LAB may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                agreement permits either you or QENEX LAB to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and QENEX LAB agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the QENEX LAB may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
