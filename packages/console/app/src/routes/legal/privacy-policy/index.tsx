...
export default function PrivacyPolicy() {
  return (
    <main data-page="legal">
      <Title>QENEX LAB | Privacy Policy</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/privacy-policy`} />
      <Meta name="description" content="QENEX LAB privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At QENEX LAB, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the QENEX LAB website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about QENEX LAB.
                </li>
