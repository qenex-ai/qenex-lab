export const TIPS = [
  ...
  "Use {highlight}/undo{/highlight} to revert the last message and any file changes made by QENEX LAB.",
  ...
  "Create {highlight}qenex-lab.json{/highlight} in project root for project-specific settings.",
  "Place settings in {highlight}~/.config/qenex-lab/qenex-lab.json{/highlight} for global config.",
  ...
  "QENEX LAB auto-handles OAuth for remote MCP servers requiring auth.",
  "Add {highlight}.md{/highlight} files to {highlight}.qenex-lab/command/{/highlight} to define reusable custom prompts.",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input.",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight}).",
  "Add {highlight}.md{/highlight} files to {highlight}.qenex-lab/agent/{/highlight} for specialized AI personas.",
  "Configure per-agent permissions for {highlight}edit{/highlight}, {highlight}bash{/highlight}, and {highlight}webfetch{/highlight} tools.",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular bash permissions.',
  'Set {highlight}"rm -rf *": "deny"{/highlight} to block destructive commands.',
  'Configure {highlight}"git push": "ask"{/highlight} to require approval before pushing.',
  "QENEX LAB auto-formats files using prettier, gofmt, ruff, and more.",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting.',
  "Define custom formatter commands with file extensions in config.",
  "QENEX LAB uses LSP servers for intelligent code analysis.",
  "Create {highlight}.ts{/highlight} files in {highlight}.qenex-lab/tool/{/highlight} to define new LLM tools.",
  "Tool definitions can invoke scripts written in Python, Go, etc.",
  "Add {highlight}.ts{/highlight} files to {highlight}.qenex-lab/plugin/{/highlight} for event hooks.",
  "Use plugins to send OS notifications when sessions complete.",
  "Create a plugin to prevent QENEX LAB from reading sensitive files.",
  "Use {highlight}qenex-lab run{/highlight} for non-interactive scripting.",
  "Use {highlight}qenex-lab run --continue{/highlight} to resume the last session.",
  "Use {highlight}qenex-lab run -f file.ts{/highlight} to attach files via CLI.",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  "Run {highlight}qenex-lab serve{/highlight} for headless API access to QENEX LAB.",
  "Use {highlight}qenex-lab run --attach{/highlight} to connect to a running server for faster runs.",
  "Run {highlight}qenex-lab upgrade{/highlight} to update to the latest version.",
  "Run {highlight}qenex-lab auth list{/highlight} to see all configured providers.",
  "Run {highlight}qenex-lab agent create{/highlight} for guided agent creation.",
  "Use {highlight}/qenex-lab{/highlight} in GitHub issues/PRs to trigger AI actions.",
  "Run {highlight}qenex-lab github install{/highlight} to set up the GitHub workflow.",
  "Comment {highlight}/qenex-lab fix this{/highlight} on issues to auto-create PRs.",
  "Comment {highlight}/ql{/highlight} on PR code lines for targeted code reviews.",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors.',
  "Create JSON theme files in {highlight}.qenex-lab/themes/{/highlight} directory.",
  ...
  "Run {highlight}qenex-lab debug config{/highlight} to troubleshoot configuration.",
  ...
  "Use {highlight}/connect{/highlight} with QENEX Zen for curated, tested models.",
  ...
  // QENEX LAB Scientific Features
  "Use {highlight}@qenex-lab{/highlight} agent for scientific discovery across Physics, Chemistry, Biology, and Math.",
  "The {highlight}Trinity Pipeline{/highlight}: Reason → Generate → Validate for all scientific tasks.",
  "Access {highlight}Scout 17B{/highlight} for deep scientific reasoning via the qenex-lab agent.",
  "Use {highlight}Q-Lang{/highlight} (.ql files) for defining physical laws, biological systems, and constraints.",
  "Run {highlight}/validate{/highlight} to verify scientific results with the 18-expert Scout CLI system.",
]
