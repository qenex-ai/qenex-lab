...
import { createOpencodeClient, type OpencodeClient } from "@qenex-lab/sdk/v2"
...
export const RunCommand = cmd({
  command: "run [message..]",
  describe: "run qenex lab with a message",
  builder: (yargs: Argv) => {
    return yargs
      .positional("message", {
      ...
      .option("attach", {
        type: "string",
        describe: "attach to a running qenex lab server (e.g., http://localhost:4096)",
      })
      .option("port", {
        type: "number",
