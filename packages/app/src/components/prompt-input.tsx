import { useFilteredList } from "@qenex-lab/ui/hooks"
import {
  createEffect,
  on,
  Component,
...
import { createOpencodeClient, type Message, type Part } from "@qenex-lab/sdk/v2/client"
import { Binary } from "@qenex-lab/util/binary"
import { showToast } from "@qenex-lab/ui/toast"
import { base64Encode } from "@qenex-lab/util/encode"
